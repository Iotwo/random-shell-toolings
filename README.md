...
<p> Предполагается, что сетевое соединение с удалённым хостом стабильно. </p>
...
<ul>
  ...
  <li>(Опционально) -H http-version: используемая версия протокола HTTP. Варианты: 0.9, 1.0, 1.1, 2. По умолчанию 1.1</li>
  <li>(Опционально) -u uri-scheme: схема доступа до ресурса, поддерживаются: http, https.</li>
